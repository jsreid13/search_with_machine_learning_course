...
# Generate labelled and stemmed queries+categories with 1k queries/category
python week3/create_labeled_queries.py --normalize --stem --min_queries 1000 --output /workspace/datasets/fasttext/labeled_stemmed_queries_1k.txt
shuf /workspace/datasets/fasttext/labeled_stemmed_queries_1k.txt > /workspace/datasets/fasttext/shuffled_labeled_stemmed_queries_1k.txt

# Split normalized labeled data into training and test
head -50000 /workspace/datasets/fasttext/shuffled_labeled_stemmed_queries_1k.txt > /workspace/datasets/fasttext/query_stemmed_1k_training_data.txt
tail -10000 /workspace/datasets/fasttext/shuffled_labeled_stemmed_queries_1k.txt > /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt
# Train model
~/fastText-0.9.2/fasttext supervised -input /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt -output /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_model_1k
# Test model for P@1 and R@1, P@3 and R@3 and P@5 and R@5
echo 1k stemmed queries/category
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt 3
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt 5


# Train model
~/fastText-0.9.2/fasttext supervised -input /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt -output /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_improved_model_1k -lr 0.05 -epoch 25 -wordNgrams 2
# Test model for P@1 and R@1, P@3 and R@3 and P@5 and R@5
echo 1k stemmed queries/category improved hyperparameters
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_improved_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_improved_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt 3
~/fastText-0.9.2/fasttext test /workspace/datasets/fasttext/bbuy_query_stemmed_cat_clf_improved_model_1k.bin /workspace/datasets/fasttext/query_stemmed_1k_test_data.txt 5

python utilities/query.py --category_filter